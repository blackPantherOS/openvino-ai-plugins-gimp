...
pip3 install "transformers>=4.21.1" "diffusers>=0.14.0" "tqdm==4.64.0" "openvino==2023.0.1" "huggingface_hub" "streamlit==1.12.0" "watchdog==2.1.9" "ftfy==6.1.1" | grep -v "already satisfied"
